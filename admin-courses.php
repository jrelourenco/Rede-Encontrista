                  ...
                  <section>
                    <form action="admin-courses.php" method="post">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" placeholder="ie Id do curso, Nome do curso, Data do curso DD/MM/YYYY, etc...">
                        </div>
                        <!-- Courses List -->                     
                        <div class="table-results">                        
                            <table class="table table-stripped">
                              ...
                              <tr>
                                ...
                                <td>Encerrado</td>
                                <td>CSh Oeiras</td>
                                <td><a href="admin-courses.php?edit=14857">Alterar</a> | <a href="admin-courses.php?remove=14857">Remover</a></td>
                              </tr>
                              <tr>
                                <td>94839</td>
                                ...
                                <td>Em inscrições</td>
                                <td>CSh Braga</td>
                                <td><a href="admin-courses.php?edit=94839">Alterar</a> | <a href="admin-courses.php?remove=94839">Remover</a></td>
                              </tr>
                              <tr>
                                <td>38743</td>
                                ...
                                <td><a href="admin-courses.php?edit=38743">Alterar</a> | <a href="admin-courses.php?remove=38743">Remover</a></td>
                              </tr>
                            </tbody>
                            </table>
